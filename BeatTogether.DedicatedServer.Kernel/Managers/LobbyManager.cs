...
namespace BeatTogether.DedicatedServer.Kernel.Managers
{
    public sealed class LobbyManager : ILobbyManager
    {
        ...
        public bool AllPlayersReady => _playerRegistry.Players.All(p => p.IsReady || !p.IsActive);
        public bool SomePlayersReady => _playerRegistry.Players.Any(p => p.IsReady);
        public bool NoPlayersReady => _playerRegistry.Players.All(p => !p.IsReady || !p.IsActive);
        public bool AllPlayersSpectating => _playerRegistry.Players.All(p => !p.IsActive);
